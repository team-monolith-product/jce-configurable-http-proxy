...
import { MemoryStore, ValkeyStore } from "./store.js";
...
const loadStorage = (options) => {
  ...
  // VALKEY_URL 이 주어지면 Valkey 백엔드. 그 외엔 in-memory MemoryStore 로
  // fallback (upstream 기본 동작 호환, Valkey 인프라가 없는 테스트/로컬 환경 보호).
